...
T=[(((1-R1)*(1-R2)*2.718**(-alpha*d))/(1-R1*R2*2.718**(-2*alpha*d)))
   for (R1,R2,alpha) in zip(R_air_Au,R_Au_verre,absorption_coeff)]


fig1=plt.figure(1)
plt.plot(Wavelengths,R_air_Au,label=("d=",str(d)))
plt.legend()
